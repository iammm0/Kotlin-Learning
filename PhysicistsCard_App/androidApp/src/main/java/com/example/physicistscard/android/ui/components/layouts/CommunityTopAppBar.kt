...
@Composable
fun CommunityTopAppBar(text: String,
                   navController: NavController, // 添加NavController参数
                   onEditClick: () -> Unit = { navController.navigate("community-edit-post") },
                   onAccountClick: () -> Unit = { navController.navigate("community-management-detail") },
                   onSearchClick: () -> Unit
) {
            ...
            Row(
                ...
                Row(
                    ...
                    IconButton(onClick = onAccountClick) {
                        Icon(Icons.Outlined.MoreVert, contentDescription = "Account")
                    }
                }
            }
        },
