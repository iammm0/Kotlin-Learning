...
fun LoginEmailScreen(
    ...
    val loginState by authViewModel.loginWithEmailCodeState.collectAsState()
    ...
    Column(
        ...
        LoginAndRegisterButton(
            text = "发送验证码",
            onClick = {
                authViewModel.sendVerificationCode(email, "email_login")
            }
        )
        ...
        LoginAndRegisterButton(
            text = "登录",
            onClick = {
                authViewModel.loginWithEmailCode(email, emailCode)
            }
        )
